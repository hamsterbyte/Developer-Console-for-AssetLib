...
namespace hamsterbyte.DeveloperConsole{
    public static partial class DC{
        ...
        public static DCDelegates.onIncrementProgress OnIncrementProgress;
        public static DCDelegates.onShowProgress OnShowProgress;
        ...
        public static void ShowProgress(int operationCount){
            OnShowProgress?.Invoke(operationCount);
        }

        public static void IncrementProgress(int i = 1){
            OnIncrementProgress?.Invoke(i);
        }
